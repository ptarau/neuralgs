...
theorems on implicational linear logic and their asscoiated
linear lambda terms in normla form

with padding handled by "."
...
questions,expected,chars,MAXLEN=theorem_qa()
...
def run() :
  for iteration in range(0, ITERATIONS):
    ...
    for i in range(GUESSES):
        ...
        print(guess)
  model.save('tlin_model.tf') #, save_format='tf')
